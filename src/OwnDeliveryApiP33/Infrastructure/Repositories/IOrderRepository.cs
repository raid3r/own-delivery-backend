...
public interface IOrderRepository : IRepository<Order>
{
    ...
    Task<IEnumerable<Order>> GetUnassignedOrdersAsync(int skip = 0, int take = 20, CancellationToken ct = default);
    Task<int> CountUnassignedOrdersAsync(CancellationToken ct = default);
